...
export function apply(ctx) {
    ctx.tools.register(defineTool({
        ...
        description: 'List built-in Agent Team Room scenario templates, their orchestration shape, roles, and human approval '
    ...
    ctx.tools.register(defineTool({
        ...
        description: 'Create a durable room from a built-in scenario template and start every role as an independent continuable '
